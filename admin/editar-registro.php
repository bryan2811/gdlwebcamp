                  ...
                  <div id="<?php echo str_replace('á','a', $dia) ?>" class="contenido-dia clearfix row">
                      ...
                      <?php foreach($eventos['eventos'] as $tipo => $evento_dia): ?>
                          <div class="col-md-4">
                              ...
                              <label>
                                <input <?php echo (in_array( $evento['id'], $id_eventos_registrados['eventos']) ? 'checked' : '' ); ?> type="checkbox" name="registro_evento[]" id="<?php echo $evento['id']; ?>" value="<?php echo $evento['id']; ?>" class="minimal"><time><?php echo $evento['hora']; ?></time> <?php echo $evento['nombre_evento']; ?>
                                <br>
      ...
      <div class="box-header with-border">
        ...
        <div class="caja clearfix row">
          ...
          <div class="total col-md-6">
            <p>Resumen</p>
            <div id="lista-productos"></div><!--lista-productos-->
