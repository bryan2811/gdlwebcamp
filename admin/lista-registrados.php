                              ...
                              <tr>
                                  ...
                                  <td>
                                      <?php 
                                        ...
                                        $talleres = json_decode($eventos_resultado, true); // True lo convierte a Array

                                        $talleres = implode("', '", $talleres['eventos']); // Todos los valores de un Array los coloca en una cadena
