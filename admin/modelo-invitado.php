...
// Forma de comprobar conexión a la BD
// if($conn->ping() ) {
//     echo "Conectado";
// } else {
//     echo "No";
...
if($_POST['registro'] == 'nuevo') {
    ...
    if(!is_dir($directorio)) { // Revisa que el directorio exista o no
        mkdir($directorio, 0755, true); // Crear directorio (Permisos y Recursivo) 0755 = Permiso recomendado en un servidor web | Recursivo = Todos los archivos de la carpeta tengan el mismo permiso
    }
