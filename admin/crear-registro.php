<?php 
  ...
  // Sesiones siempre va de primero!
        ...
        <div class="col-md-8">
            ...
            <section class="content">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <!-- form start -->
                  <form role="form" name="guardar-registro_evento" id="guardar-registro_evento" method="post" action="modelo-registrado.php">
                      <div class="box-body">
          ...
          <div class="caja">
              ...
              <?php
                ...
                while($eventos = $resultado->fetch_assoc()) {
                    ...
                    setLocale(LC_ALL, 'es_ES'); // Poner en español los días, tambien se cambia el lenguaje del servidor
                  ...
                  <div id="<?php echo str_replace('á','a', $dia) ?>" class="contenido-dia clearfix row">
                      ...
                      <?php foreach($eventos['eventos'] as $tipo => $evento_dia): ?>
                          <div class="col-md-4">
                              ...
                              <label>
                                <input type="checkbox" name="registro_evento[]" id="<?php echo $evento['id']; ?>" value="<?php echo $evento['id']; ?>" class="minimal"><time><?php echo $evento['hora']; ?></time> <?php echo $evento['nombre_evento']; ?>
                                <br>
